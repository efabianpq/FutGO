...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'compression_method' => defined('ZipArchive::CM_DEFAULT') ? ZipArchive::CM_DEFAULT : 6,
             ...
             * En producción con R2: agregar 'r2' a este array y configurar
             * las variables R2_* en el .env.
             */
            'disks' => array_filter([
                'local',
                env('BACKUP_DISK'),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
            /*
             * Mínimo requerido P-0: todos los backups de los últimos 7 días.
             */
