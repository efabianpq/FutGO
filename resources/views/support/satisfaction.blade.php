...
<div class="max-w-lg mx-auto px-4 py-16 text-center">
    @if($response === 'positiva')
        <div class="mb-4 flex justify-center"><x-icon name="check-circle" class="w-12 h-12 text-green" /></div>
    ...
    @else
        <div class="mb-4 flex justify-center"><x-icon name="heart" class="w-12 h-12 text-muted" /></div>
